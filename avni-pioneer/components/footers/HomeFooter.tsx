...
const HomeFooter = () => {
  ...
  return (
    <footer className='bg-wild-sand pt-[100px] pb-[50px] px-[22%] -mx-[21.4%] overflow-hidden dark:bg-woodsmoke phones:pt-[84px]'>
      ...
      <FooterDropdown expandedHeight={420} options={serviceOptions} title='Customer Services' />
      <FooterDropdown expandedHeight={345} options={aboutOptions} title='About Avni Furniture' />
