...
const ARTICLES: Article[] = [
  {
    id: 1,
    createdAt: '2022-12-30T11:13:00Z',
    updatedAt: '2022-12-30T11:13:00Z',
    title: 'Deforestation',
    image: articleImage,
    article:
  ...
  {
    id: 2,
    createdAt: '2022-11-30T11:13:00Z',
    updatedAt: '2022-12-10T11:13:00Z',
  ...
  {
    id: 3,
    createdAt: '2022-01-15T11:13:00Z',
    updatedAt: '2022-01-16T11:13:00Z',
...
export async function getStaticProps() {
  ...
  return {
    props: {
      articles: ARTICLES.map(({ id, title, image, article, createdAt }) => ({
        id,
        title,
        image,
        article,
