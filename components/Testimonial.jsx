const Testimonial = () => {
  return (
    <section className='grid grid-rows-[repeat(2,auto)] grid-cols-2 gap-y-[87px] mt-52 phones:grid-rows-[repeat(3,auto)] phones:grid-cols-1'>
      <h2 className='text-[30px] leading-[45px] max-w-[80%] laptops:text-[25px] phones:text-center phones:mx-auto phones:max-w-[60%]'>
        What others are saying about us
      </h2>

      <div className='text-[14px] leading-[21px] max-w-[70%] ml-auto phones:text-center phones:mx-auto'>
      ...
      <div className='h-[560px] bg-[url(/assets/pngs/customers.png)] bg-cover bg-center bg-no-repeat col-start-1 col-end-3 flex items-end phones:h-48 phones:col-end-auto'>
